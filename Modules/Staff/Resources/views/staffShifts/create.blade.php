...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"> Create Staff Shift</li>
    </ol>
@endsection
        ...
        <div class="col-md-12">
            <div class="portlet box primary">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="livicon" data-name="camera" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Create Staff Shift
                    </div>
                </div>
                <div class="portlet-body">
                    <form action="{{ route('staffShifts.store')  }}" class="form-horizontal" method="POST">
                        @csrf
