<div class="modal fade modal-fade-in-scale-up" ng-controller="addDomainForwardingController" tabindex="-1" id="modal-add-df" role="dialog" aria-labelledby="modalLabelfade" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h4 class="modal-title" id="modalLabelfade">Add Domai</h4>
            </div>
            <div class="modal-body">
                <form method="post" ng-submit="editForwardDomainSecret()" name="editDomainForwardingForm">
