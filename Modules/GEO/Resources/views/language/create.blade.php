...
@section('title', __('admin.general.create') .' '.__('admin.geo.language'))
...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"> @lang('admin.general.create') @lang('admin.geo.language')</li>
    </ol>
@endsection
        ...
        <div class="col-md-12">
            <div class="portlet box primary">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="livicon" data-name="camera" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> @lang('admin.general.create') @lang('admin.geo.language')
                    </div>
                </div>
                <div class="portlet-body">
                    <form action="{{ route('languages.store')  }}" class="form-horizontal" method="POST">
                        @csrf
