...
@section('title',  __('admin.general.import').' '.__('admin.geo.country'))
...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"> @lang('admin.general.import') @lang('admin.geo.country')</li>
    </ol>
@endsection
        ...
        <div class="col-md-12">
            <div class="portlet box primary">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="livicon" data-name="camera" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> @lang('admin.general.import') @lang('admin.geo.country')
                    </div>
                </div>
                <div class="portlet-body">
                    <form action="{{ route('countries.import.post')  }}" class="form-horizontal" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <p class="text-warning">You can download sample file of csv from here: <a href="/Modules/GEO/Demo/country_import_test.csv">country_import_test.csv</a></p>
                                </div>
                            </div>
