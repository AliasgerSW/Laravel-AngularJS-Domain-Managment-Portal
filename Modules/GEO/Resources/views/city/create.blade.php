...
@section('title', __('admin.general.create').' '.__('admin.geo.city'))
...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"> @lang('admin.general.create') @lang('admin.geo.city')</li>
    </ol>
@endsection
        ...
        <div class="col-md-12">
            <div class="portlet box primary">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="livicon" data-name="camera" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> @lang('admin.general.create') @lang('admin.geo.city')
                    </div>
                </div>
